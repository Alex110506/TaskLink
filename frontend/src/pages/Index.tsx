  ...
  const features = [
    {
      ...
      description:
        "Find talented freelancers in your area or anywhere in the world. Filter by location, timezone, and availability.",
    ...
    },
    {
      ...
      description:
        "Search for professionals with specific skills and expertise. Filter by experience level, ratings, and past work.",
    ...
    },
    {
      ...
      description:
        "Build and manage your teams with ease. Assign roles, track progress, and collaborate in real-time.",
    ...
    },
    {
      ...
      description:
        "Create, assign, and track tasks effortlessly. Set deadlines, priorities, and monitor project progress.",
    ...
    },
    {
      ...
      description:
        "Connect with professionals, share updates, and build your network. Engage with the community.",
    ...
    },
    {
      ...
      description:
        "Post jobs or find opportunities. Streamlined hiring process with built-in communication tools.",
  ...
  const testimonials = [
    {
      ...
      image: "👩‍💼",
      quote:
        "TaskLink transformed how we manage our distributed team. The location-based features are a game-changer!",
    },
    {
      name: "Marcus Johnson",
      ...
      image: "👨‍🎨",
      quote:
        "I've found amazing projects and clients through TaskLink. The platform is intuitive and professional.",
    },
    {
      name: "Aisha Patel",
      ...
      image: "👩‍💻",
      quote:
        "Best platform for hiring tech talent. The skill matching is incredibly accurate and saves us time.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            {!user && !businessUser ? (
              ...
              <Link to="/">
                <Button
                  className="bg-gradient-to-r from-primary via-blue-600 to-accent
               text-white
               hover:opacity-90 hover:shadow-primary/50
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-in fade-in slide-in-from-left duration-700">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                TaskLink brings businesses and freelancers together on a unified
                platform. Find talent based on location and skills, manage your
                teams, and track projects-all in one place.
              </p>
              ...
              {!user && !businessUser && (
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/auth">
                    <Button
                      size="lg"
                      className="bg-gradient-to-r from-primary via-blue-600 to-accent hover:opacity-90 shadow-lg shadow-primary/40 text-lg h-14 px-8 transition-all hover:shadow-xl hover:shadow-primary/50"
                    >
                      Start for Free
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-2 border-primary/30 hover:bg-primary/10 hover:border-primary text-lg h-14 px-8 transition-all"
                  >
                    Sign In
                    <span className="ml-2">▶</span>
                  </Button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-in fade-in slide-in-from-bottom duration-700">
            ...
            <p className="text-xl text-muted-foreground">
              Powerful features designed to help businesses and freelancers work
              together seamlessly
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <CardContent className="p-6 space-y-4">
                  <div
                    className={`w-16 h-16 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center text-3xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg`}
                  >
                    {feature.icon}
                  </div>
      ...
      <section className="py-20 relative bg-gradient-to-b from-background to-blue-900/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Unlock AI-powered tools and location intelligence with our Pro
              plan.
            </p>
          </div>
              ...
              <CardContent>
                <ul className="space-y-4">
                  <li className="flex items-center gap-3 text-sm text-muted-foreground">
                    <Check className="h-4 w-4 text-primary" /> Basic Profile
                    Creation
                  </li>
                  <li className="flex items-center gap-3 text-sm text-muted-foreground">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="bg-gradient-to-br from-card/80 to-card backdrop-blur-sm border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-xl"
              >
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-blue-600 flex items-center justify-center text-2xl">
