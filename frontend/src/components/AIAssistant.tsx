...
export function AIAssistant({ jobsData, userData }) {
    ...
    const handleSend = async () => {
        ...
        setMessages(prev => [...prev, { id: Date.now(), sender: "user", text: input }]); setInput("");
        const sendPrompt = async (userMessage, jobsData, userData) => {
            try {
                ...
                setMessages(prev => [...prev, { id: Date.now(), sender: "ai", text: data.data }]);
        ...
        sendPrompt(input, jobsData, userData)
    };
